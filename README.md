...
git clone https://github.com/zarishsphere/zs-svc-communicable-disease.git
cd zs-svc-communicable-disease
...
See [docs.zarishsphere.com/api/zs-svc-communicable-disease](https://docs.zarishsphere.com/api/zs-svc-communicable-disease) for the full OpenAPI 3.1 specification.
